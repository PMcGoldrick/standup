...
#
basedir="$HOME/installation-scripts/ubuntu-unattended"
...
preseed netcfg/get_ipaddress string $IP
preseed netcfg/get_netmask string $NETMASK
preseed netcfg/get_gateway string $GATEWAY
preseed netcfg/get_nameservers string $DNS
preseed netcfg/confirm_static boolean true
network --bootproto=static --hostname=$HOSTNAME --device=$NETDEV
